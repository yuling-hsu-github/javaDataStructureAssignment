...
public class SimpleBinaryTree {
	    ...
	    public static void breadthFirst(SimpleBinaryTree t){
	    	...
	    	LinkedListPureQueue<Object> Queue = new LinkedListPureQueue<>();
	    	Queue.enqueue(t);
	    	while(!Queue.isEmpty()){
	    		t = (SimpleBinaryTree) Queue.dequeue();
	    		System.out.print(t.value);
	    		System.out.print(", ");
	    		if(t.leftChild!=null) {
	    			Queue.enqueue(t.leftChild);
	    			
	    		}if(t.rightChild!=null) {
	    			Queue.enqueue(t.rightChild);
	    		}
	    	}
	    	/*
	    	    if(t == null) return;
	    	    ...
	    	    while (!Queue.isEmpty()) {
	    	    	 t = (SimpleBinaryTree) Queue.dequeue();
	    	    	System.out.print(t.value);
	    	    if(t.leftChild != null) {Queue.enqueue(t.leftChild);}
	    	    if(t.rightChild != null) {Queue.enqueue(t.rightChild);}
	    	    }*/
	    	    }
